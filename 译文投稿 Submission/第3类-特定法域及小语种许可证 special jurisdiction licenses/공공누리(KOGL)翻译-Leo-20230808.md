...
![第一种类型标志](공공누리(KOGL)中的标识-Leo/第一种类型标志.png)
...
![KOGL使用条款-韩文（第一种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-韩文（第一种类型）.png) &nbsp;&nbsp; 한글 Korean 韩文

![KOGL使用条款-英文（第一种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英文（第一种类型）.png) &nbsp;&nbsp; 영문 English 英文

![KOGL使用条款-英韩（第一种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英韩（第一种类型）.png) &nbsp;&nbsp; 한영 English-Korean 韩英对照
...
![个别条款1（第一类型）](공공누리(KOGL)中的标识-Leo/个别条款1（第一类型）.png)&nbsp;&nbsp; 출처표시  Indication of the source 注明出处
...
![第二种类型标志](공공누리(KOGL)中的标识-Leo/第二种类型标志.png)
...
![KOGL使用条款-韩文（第二种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-韩文（第二种类型）.png) &nbsp;&nbsp; 한글 Korean 韩文

![KOGL使用条款-英文（第二种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英文（第二种类型）.png) &nbsp;&nbsp; 영문 English 英文

![KOGL使用条款-英韩（第二种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英韩（第二种类型）.png) &nbsp;&nbsp; 한영 English-Korean 韩英对照
...
![个别条款1（第二类型）](공공누리(KOGL)中的标识-Leo/个别条款1（第二类型）.png) &nbsp;&nbsp; 출처표시  Indication of the source 注明出处
...
![个别条款2（第二类型）](공공누리(KOGL)中的标识-Leo/个别条款2（第二类型）.png) &nbsp;&nbsp; 상업적 이용금지 Commercial Use Prohibition  禁止商用
...
![第三种类型标志](공공누리(KOGL)中的标识-Leo/第三种类型标志.png) 
...
![KOGL使用条款-韩文（第三种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-韩文（第三种类型）.png) &nbsp;&nbsp; 한글 Korean 韩文

![KOGL使用条款-英文（第三种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英文（第三种类型）.png) &nbsp;&nbsp;영문 English 英文

![KOGL使用条款-英韩（第三种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英韩（第三种类型）.png) &nbsp;&nbsp;
...
![个别条款1（第三种类型）](공공누리(KOGL)中的标识-Leo/个别条款1（第三种类型）.png) &nbsp;&nbsp; 출처표시  Indication of the source  注明出处
...
![个别条款2（第三种类型）](공공누리(KOGL)中的标识-Leo/个别条款2（第三种类型）.png) &nbsp;&nbsp; 변경금지  Change Prohibition  禁止变更
...
![第四种类型标志](공공누리(KOGL)中的标识-Leo/第四种类型标志.png)
...
![KOGL使用条款-韩文（第四种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-韩文（第四种类型）.png)&nbsp;&nbsp;한글 Korean 韩文

![KOGL使用条款-英文（第四种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英文（第四种类型）.png)&nbsp;&nbsp;영문 English 英文

![KOGL使用条款-英韩（第四种类型）](공공누리(KOGL)中的标识-Leo/KOGL使用条款-英韩（第四种类型）.png)&nbsp;&nbsp;한영 English-Korean 韩英对照
...
![个别条款1（第四类型）](공공누리(KOGL)中的标识-Leo/个别条款1（第四类型）.png)&nbsp;&nbsp;
...
![个别条款2（第四类型）](공공누리(KOGL)中的标识-Leo/个别条款2（第四类型）.png)&nbsp;&nbsp; 상업적 이용금지 Commercial Use Prohibition  禁止商用
...
![个别条款3（第四类型）](공공누리(KOGL)中的标识-Leo/个别条款3（第四类型）.png)&nbsp;&nbsp; 변경금지 Change Prohibition  禁止变更
